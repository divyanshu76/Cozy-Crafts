...
export async function generateMetadata({ params }: ProductPageProps) {
  ...
  const url = `https://www.cozycrafts.shop/product/${product.slug}`;

  return {
    title: `${product.name} | Cozy Craft`,
    description: product.shortDescription || product.description,
    keywords: [product.name, "handmade", product.category, "Cozy Craft"],
    alternates: {
      canonical: url,
    },
    openGraph: {
...
export default async function ProductPage({ params }: ProductPageProps) {
  ...
  const productJsonLd = {
    ...
    url: `https://www.cozycrafts.shop/product/${product.slug}`,
    brand: {
      "@type": "Brand",
      name: "Cozy Craft",
    },
