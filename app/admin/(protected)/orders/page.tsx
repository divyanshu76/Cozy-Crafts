  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-8">
        ...
        <Suspense fallback={<div className="h-10 w-48 bg-taupe/10 animate-pulse rounded-lg" />}>
            ...
            return (
              <div key={order.id} className="p-4 space-y-3">
                <div className="flex items-center justify-between gap-2">
                  <span className="font-mono font-medium text-sage text-sm">
                ...
                <div className="flex items-center justify-between text-xs text-espresso-soft">
                  ...
                  <span className="text-xs font-medium text-espresso px-2 py-0.5 bg-cream-soft border border-taupe/20 rounded">
                    {order.payment_method || "PREPAID"}
                  </span>
                </div>

                <div className="text-xs text-espresso-soft truncate">
                  {customer?.email ?? customer?.phone ?? "Guest Customer"}
                </div>

                <div className="flex items-center justify-between pt-1 border-t border-taupe/5">
